...
export const metadata: Metadata = { title: 'Observer | Cardinal' }
  ...
  return (
    <div style={{ paddingTop: 'calc(var(--nav-height) + 4rem)', paddingBottom: '6rem', paddingInline: 'var(--gutter)', minHeight: '60vh' }}>
      <div style={{ maxWidth: 'var(--max-read)', marginInline: 'auto' }}>
        <Reveal>
          <h1 style={{ fontFamily: 'var(--font-display)', fontSize: 'clamp(2rem, 5vw, 3rem)', fontWeight: 500, color: 'var(--text)', margin: '0 0 1.5rem' }}>Observer</h1>
